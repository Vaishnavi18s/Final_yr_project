...
def user_input(user_question, model_name, api_key, pdf_docs, conversation_history):
    ...
    st.snow()
def main():
    st.set_page_config(page_title="Read PDFs and simplify Q&A with Vaishnavi and team", page_icon=":books:")
    st.header("Read PDFs and simplify Q&A with Vaishnavi and team (v1) :books:")

    if 'conversation_history' not in st.session_state:
        st.session_state.conversation_history = []
    linkedin_profile_link = "https://www.linkedin.com/in/evolvingishanarora/"
    kaggle_profile_link = "https://www.kaggle.com/evolvingishanarora"
    github_profile_link = "https://github.com/IshanAroraEvolve"
